...
const ProjectDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black p-8 md:p-12 font-sans relative">
      ...
      {/* Main container */}
      <div className="max-w-8xl mx-auto px-4 sm:px-6  py-12 mb-4">
        {/* Project header */}
      ...
      {/* about container */}
      <div className="max-w-8xl mx-auto px-4 sm:px-6 py-12 mt-10">
        {/* Top Row */}
      ...
      {/* testimonial section */}
      <div className='max-w-8xl mx-auto px-4 sm:px-6 py-12 mt-10'>
        <p className="text-3xl font-medium text-black mb-20 tracking-wide ">snapshot.</p>
