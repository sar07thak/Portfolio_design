...
[
  ...
  },
  {
    ...
    "year": 2024,
    "type": "Frontend",
    "frontImage": "../assets/Guess/Front.png",
    "sideImage": [
      "../assets/Guess/1.png",
      "../assets/Guess/2.png",
      "../assets/Guess/3.png"
    ],
    "about": "The GuessNumber Game is a fun and interactive web-based game built using HTML, CSS, and JavaScript. Players try to guess a randomly generated number within a limited number of attempts, receiving real-time feedback after each guess. The game features a clean and responsive design with simple logic that makes it engaging for all age groups. It's a great demonstration of core JavaScript concepts like DOM manipulation, conditionals, and event handling.",
    "shortDescription": "The GuessNumber Game brings classic number guessing to life with a modern touch, blending minimalist design with responsive interactions. Built with pure HTML, CSS, and JavaScript, it's a quick and fun challenge for users of all ages."
  },
  {
    "name": "Portfolio",
  ...
  },
  {
    ...
    "type": "GenAi",
    "frontImage": "../assets/Ai/Front.png",
    "sideImage": [
      "../assets/Ai/1.png",
      "../assets/Ai/2.png",
      "../assets/Ai/3.png",
    ...
    "year": 2025,
    "about": "AI Image Identifier is a sleek React web app that uses the Google Gemini API to analyze and describe uploaded images. With drag-and-drop support, responsive design, and smooth error handling, it offers an intuitive experience for users. Built using React and Tailwind CSS, this project showcases how to integrate advanced AI capabilities into modern frontend applications.",
    "shortDescription": "AI Image Identifier is a smart, minimal web app that turns images into words using the power of Google Gemini. Upload or drag-and-drop a photo, and let AI generate detailed, human-like descriptions—all within a clean, responsive interface."
  }
]